...
try:
    ...
    try:
        from models.PAVER.model import get_extractor
        from models.PAVER.exp import ex
        from models.PAVER.data.utils import save_by_segment, load_by_segment, serial_save_by_segment, serial_load_by_segment, FastLoader
    except:
        from PAVER.model import get_extractor
        from PAVER.exp import ex
        from PAVER.data.utils import save_by_segment, load_by_segment, serial_save_by_segment, serial_load_by_segment, FastLoader
