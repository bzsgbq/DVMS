...
def compute_patch(resolution, patch, ang_y, ang_z, is_discrete=False):
    '''
...
def compute_deform_offset(patch_size, resolution, is_discrete=False):
    ...
    patches = compute_all_patches(patch_size=patch_size, resolution=resolution, is_discrete=is_discrete)
    deform_offset = []
