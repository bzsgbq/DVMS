...
try:
    from models.MTSMixer.layers.Invertible import RevIN
    from models.MTSMixer.layers.Projection import ChannelProjection
    from models.MTSMixer.utils.decomposition import svd_denoise, NMF
except:
...
class MixerBlock(nn.Module):
    def __init__(self, tokens_dim, channels_dim,  # tokens_dim = seq_len, channels_dim = enc_in
                 tokens_hidden_dim, channels_hidden_dim,  # tokens_hidden_dim = d_model, channels_hidden_dim = d_ff
